...
//}
//
//- (void)postData:(successful)result id:(nonnull NSString *)idStr {
//    NSString *str = [NSString stringWithFormat:@"%shttps://douban.uieee.com/v2/movie/subject/%@", FrontApi, idStr];
...
//            DBDetailModel *detailModel = [[DBDetailModel alloc] initWithDictionary:detailDictionary error:nil];
//            result(detailModel);
//        }
//    }];
//    [dataTask resume];
